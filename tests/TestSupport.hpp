    ...
    const std::string& price_json = "\"1.085000000\"")
{
    ...
    return "{\"ts_recv\":\"" + timestamp + "\",\"hd\":{\"ts_event\":\"" + timestamp + "\",\"rtype\":160,\"publisher_id\":101,\"instrument_id\":442}" + ",\"action\":\"" + std::string(1, action) + "\",\"side\":\"" + std::string(1, side) + "\",\"price\":" + price_json + ",\"size\":10,\"channel_id\":23,\"order_id\":\"" + std::to_string(order_id) + "\",\"flags\":0,\"ts_in_delta\":0,\"sequence\":0,\"symbol\":\"FCEU SI 20260316 PS\"}";
}
