...
int main()
{
    try
    {
        ...
        md::test::testIntegratedBacktestEngineSubscriberReceivesOnlyOwnInstrument();
        md::test::testIntegratedBacktestEngineMultipleSubscribersReceiveSameMessage();
        md::test::testIntegratedBacktestEngineSeqNoIsPerInstrument();
        md::test::testIntegratedBacktestEnginePublishesTradeCallbacks();
        md::test::testIntegratedBacktestEngineInstrumentFilterSkipsUnconfiguredEvents();
        md::test::testIntegratedBacktestEngineSnapshotAppearsOnConfiguredInterval();
        md::test::testIntegratedBacktestEngineMaxEventsStopsReplay();
        md::test::testIntegratedBacktestEngineFinalLobMatchesDirectStore();
        md::test::testIntegratedBacktestEngineChronologicalViolationsRemainZeroForSortedInput();
        md::test::testMarketDataEventAdapterAddAskUpdatesBestAsk();
        md::test::testMarketDataEventAdapterAddBidUpdatesBestBid();
        md::test::testMarketDataEventAdapterModifyChangesPriceAndSize();
        md::test::testMarketDataEventAdapterCancelReducesAndRemovesOrder();
        md::test::testMarketDataEventAdapterClearClearsOneInstrument();
        md::test::testMarketDataEventAdapterTradePublishesTradeWithoutMutatingLob();
        md::test::testMarketDataEventAdapterNonePublishesNothing();
        md::test::testMarketDataEventAdapterPublishesSnapshotAfterInterval();
        md::test::testMarketDataEventAdapterFiltersInstruments();
        md::test::testMarketDataEventAdapterEqualTimestampsUseSourceTieBreaker();
        md::test::testOrderExecutionBridgeBuyLimitCrossesBestAsk();
        md::test::testOrderExecutionBridgeSellLimitCrossesBestBid();
        md::test::testOrderExecutionBridgeBuyBelowAskRestsBid();
        md::test::testOrderExecutionBridgeSellAboveBidRestsAsk();
        md::test::testOrderExecutionBridgePartialFillLeavesRemainingResting();
        md::test::testOrderExecutionBridgeInvalidOrderRejectedWithoutEngineViewMutation();
        md::test::testOrderExecutionBridgeCancelRemovesRestingSyntheticOrder();
        md::test::testOrderExecutionBridgeModifyReplacesRestingSyntheticOrder();
        md::test::testOrderExecutionBridgeUnknownCancelAndModifyReject();
        md::test::testOrderExecutionBridgePrivateLiquidityPerEngine();
